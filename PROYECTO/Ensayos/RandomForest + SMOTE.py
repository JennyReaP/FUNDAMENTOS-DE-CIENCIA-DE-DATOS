...
# ENTRENAMIENTO RANDOMFOREST + SMOTE
...
print("\n Reporte de clasificación GRUPO_EDAD_AGRUPADA con SMOTE:")
...
plt.title("Matriz de Confusión - EDAD_AGRUPADA (RandomForest + SMOTE)")
plt.xlabel("Predicho")
plt.ylabel("Verdadero")
plt.tight_layout()
plt.savefig('EDAD_AGRUPADA (RandomForest + SMOTE).png')
plt.show()