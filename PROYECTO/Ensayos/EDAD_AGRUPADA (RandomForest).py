...
# ENTRENAMIENTO EDAD_AGRUPADA (RANDOMFOREST)
...
print("\n Reporte de clasificación GRUPO_EDAD AGRUPADO RandomForest:")
...
plt.title("Matriz de Confusión - GRUPO_EDAD_AGRUPADA (RandomForest)")
plt.xlabel("Predicho")
plt.ylabel("Verdadero")
plt.tight_layout()
plt.savefig('GRUPO_EDAD_AGRUPADA (RandomForest).png')
plt.show()
