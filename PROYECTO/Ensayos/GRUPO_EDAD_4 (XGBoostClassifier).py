...
# ENTRENAMIENTO GRUPO_EDAD_4 (XGBOOSTCLASSIFIER)
...
print("\n Reporte de clasificación 4Grupos XGBoost:")
...
plt.title("Matriz de Confusión - GRUPO_EDAD_4 (XGBoostClassifier)")
plt.xlabel("Predicho")
plt.ylabel("Verdadero")
plt.tight_layout()
plt.savefig('GRUPO_EDAD_4 (XGBoostClassifier).png')
plt.show()