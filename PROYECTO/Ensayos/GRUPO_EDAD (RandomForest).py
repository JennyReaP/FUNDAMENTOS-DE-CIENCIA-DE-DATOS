...
# ENTRENAMIENTO GRUPO_EDAD (RANDOMFOREST)
...
# Eliminar registros con valores nulos en las columnas seleccionadas
...
# Preprocesamiento: OneHotEncoder para categóricas, StandardScaler para numéricas
...
# Evaluación
print("\n Reporte de clasificación GRUPO_EDAD RandomForest:")
...
plt.title("Matriz de Confusión - GRUPO_EDAD (RandomForest)")
plt.xlabel("Predicho")
plt.ylabel("Verdadero")
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig('GRUPO_EDAD (RandomForest).png')
plt.show()
