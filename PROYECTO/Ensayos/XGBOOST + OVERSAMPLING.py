...
# ENTRENAMIENTO XGBOOST + OVERSAMPLING
...
# Pipeline con RandomOverSampler
...
# Evaluar
print("\n Reporte de clasificación EDAD_AGRUPADA XGBoost con Oversampling:")
...
plt.title("Matriz de Confusión - EDAD_AGRUPADA (XGBoost + Oversampling)")
plt.xlabel("Predicho")
plt.ylabel("Verdadero")
plt.tight_layout()
plt.savefig('EDAD_AGRUPADA (XGBoost + Oversampling).png')
plt.show()