...
# Evaluación
print("\n Reporte de clasificación GRUPO_EDAD_AGRUPADA XGBoost con SMOTE:")
...
plt.title("Matriz de Confusión - EDAD_AGRUPADA (XGBoost + SMOTE)")
plt.xlabel("Predicho")
plt.ylabel("Verdadero")
plt.tight_layout()
plt.savefig('EDAD_AGRUPADA (XGBoost + SMOTE).png')
plt.show()